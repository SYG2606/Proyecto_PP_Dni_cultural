...
<section id="paso1" class="formulario-paso1 active animate__animated animate__fadeInDown">
          ...
          <form id="registroForm" method="POST" action="/Proyecto_PP_Dni_cultural/public/guardar_registro.php">
  ...
  <div class="input-group">
    ...
    <input type="password" id="confirmarPassword" name="confirmarPassword" placeholder="Repetí tu contraseña" autocomplete="new-password" required>
  </div>

  <div class="checkbox-group">
    <input type="checkbox" id="terminos" required>
    <label for="terminos">Acepto los <a href="/src/views/pages/public/terminos_condiciones.html">Términos y condiciones</a></label>
  </div>

<button type="button" class="btn-principal" id="btn-continuar">Registrarme</button>
        ...
        <section id="paso2" class="formulario-paso2">
            ...
            <form id="interesesForm">
                ...
                <div class="botones-navegacion">
                    ...
                    <button type="button" class="btn-principal" id="btn-siguiente">Siguiente</button>
                </div>
            </form>
        </section>
  ...
  <script src="/Proyecto_PP_Dni_cultural/static/js/registro.js" /></script>
